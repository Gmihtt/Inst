...
module Types.Telegram.Types.Keyboard.InlineKeyboardButton (InlineKeyboardButton(..), mkInlineKeyboardButton) where
...
mkInlineKeyboardButton text url callback = InlineKeyboardButton {
  text = text,
  url = url,
