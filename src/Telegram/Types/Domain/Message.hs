...
module Telegram.Types.Domain.Message
  ( Message (..),
    mkMessage,
  )
where
...
import Telegram.Types.Domain.Chat (Chat)
import Telegram.Types.Domain.MessageEntity (MessageEntities)
import Telegram.Types.Domain.User (User)
